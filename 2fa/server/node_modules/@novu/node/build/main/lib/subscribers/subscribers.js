...
var Subscribers = (function (_super) {
    ...
    Subscribers.prototype.list = function (page) {
    ...
    Subscribers.prototype.getNotificationsFeed = function (subscriberId, params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.get("/subscribers/".concat(subscriberId, "/notifications/feed"), {
                            params: params,
                        })];
                    case 1: return [2, _a.sent()];
                }
    ...
    Subscribers.prototype.markMessageSeen = function (subscriberId, messageId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.post("/subscribers/".concat(subscriberId, "/messages/").concat(messageId, "/seen"))];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    Subscribers.prototype.markMessageActionSeen = function (subscriberId, messageId, type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.post("/subscribers/".concat(subscriberId, "/messages/").concat(messageId, "/actions/").concat(type))];
                    case 1: return [2, _a.sent()];
                }
            });
        });
